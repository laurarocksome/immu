...
const TODO_METADATA: Record<string, { phase: string; when: string; phaseColor: string }> = {
  ...
  "dashboard.todo.reintroduceEggYolk":     { phase: "Reintroduction", when: "Day 1",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.restDay":                { phase: "Reintroduction", when: "Day 2",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.observeSymptoms":        { phase: "Reintroduction", when: "Day 2",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroducePeas":        { phase: "Reintroduction", when: "Day 3",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatVegetables":          { phase: "Reintroduction", when: "Day 4",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceGhee":        { phase: "Reintroduction", when: "Day 5",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.lemonWater":             { phase: "Reintroduction", when: "Day 5",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.calmingMusic":           { phase: "Reintroduction", when: "Day 5",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.stretching":             { phase: "Reintroduction", when: "Day 6",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceSpices":      { phase: "Reintroduction", when: "Day 7",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.meditate":               { phase: "Reintroduction", when: "Day 7",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.cookDinner":             { phase: "Reintroduction", when: "Day 8",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceCocoa":       { phase: "Reintroduction", when: "Day 9",                         phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceNutOil":      { phase: "Reintroduction", when: "Day 11",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.extraWater":             { phase: "Reintroduction", when: "Day 11",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceSprouts":     { phase: "Reintroduction", when: "Day 13",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.newVegetables":          { phase: "Reintroduction", when: "Day 13",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.meditateLonger":         { phase: "Reintroduction", when: "Day 14",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceAlmonds":     { phase: "Reintroduction", when: "Day 15",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatAlmonds":             { phase: "Reintroduction", when: "Days 16–17",                    phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.almondMilk":             { phase: "Reintroduction", when: "Days 16–17",                    phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceSeeds":       { phase: "Reintroduction", when: "Day 18",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatSeeds":               { phase: "Reintroduction", when: "Days 19–20",                    phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.avoidMixing":            { phase: "Reintroduction", when: "Day 20",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.noNewFood":              { phase: "Reintroduction", when: "Days 34–36 (paprika trial)",    phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceEggWhites":   { phase: "Reintroduction", when: "Day 21",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatEggWhites":           { phase: "Reintroduction", when: "Day 22",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.grounding":              { phase: "Reintroduction", when: "Day 22",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatWholeEgg":            { phase: "Reintroduction", when: "Day 23",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceButter":      { phase: "Reintroduction", when: "Day 24",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatButter":              { phase: "Reintroduction", when: "Days 25–26",                    phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reviewList":             { phase: "Reintroduction", when: "Day 27",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.calmingActivity":        { phase: "Reintroduction", when: "Day 27",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceCashews":     { phase: "Reintroduction", when: "Day 28",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.tea":                    { phase: "Reintroduction", when: "Days 28–29",                    phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatCashews":             { phase: "Reintroduction", when: "Day 29",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroducePotato":      { phase: "Reintroduction", when: "Day 30",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroducePepper":      { phase: "Reintroduction", when: "Day 31",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatPepper":              { phase: "Reintroduction", when: "Days 32–33",                    phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroducePaprika":     { phase: "Reintroduction", when: "Day 34",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatPaprika":             { phase: "Reintroduction", when: "Days 35–36",                    phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceEggplant":    { phase: "Reintroduction", when: "Day 37",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceRice":        { phase: "Reintroduction", when: "Day 38",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.deepBreathing":          { phase: "Reintroduction", when: "Days 38–40",                    phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.relaxingRitual":         { phase: "Reintroduction", when: "Days 38, 40",                   phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatRice":                { phase: "Reintroduction", when: "Days 39–40",                    phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceYogurt":      { phase: "Reintroduction", when: "Day 41",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatYogurt":              { phase: "Reintroduction", when: "Days 42–43",                    phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.reintroduceTomato":      { phase: "Reintroduction", when: "Day 44",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.eatTomato":              { phase: "Reintroduction", when: "Day 45",                        phaseColor: "bg-green-100 text-green-800" },
  "dashboard.todo.continueReintroductions":{ phase: "Reintroduction", when: "Day 45+",                       phaseColor: "bg-green-100 text-green-800" },
