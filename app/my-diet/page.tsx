      ...
      <main className="flex-1 px-4 pb-8 overflow-auto">
        <div className="max-w-md mx-auto">
          <div className="my-8 text-center">
            <h2 className="text-3xl font-bold mb-2 text-brand-dark">{t("myDiet.title", "My Diet")}</h2>
            <p className="text-brand-dark/50 text-sm">{t("myDiet.subtitle", "Your current diet plan")}</p>
          </div>
